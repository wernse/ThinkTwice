...
public class FatSecretAPI {
	...
	public FatSecretAuth foodGet() throws FatSecretException {
	...
	/* Private Methods */
    public String doHttpMethodReq(String urlStr, String requestMethod, String paramStr, Map<String, String> header) throws FatSecretException{
